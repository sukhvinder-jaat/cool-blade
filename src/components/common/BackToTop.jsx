  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-4 right-4 bg-gradient-to-br from-hippyGreen to-treeGreen text-white p-4 rounded-full z-50 transition-all duration-300 animate-pulse border-0 hover:scale-95 ${
